...
% vurdere og sette dem opp mot hadily available, this is one of the primary challenges.
% + Facebook Messenger data dump.
% + Clarino: Tried, but restrictive licenses.
...
% + Teacher forcing
% Future work: Bert/custom embeddings, embedding layer, bidirectional model, beam search
